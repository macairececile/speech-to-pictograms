...
if __name__ == "__main__":
    ...
    from processing import prepare_common_voice  # noqa
    ...
    # Valid
    asr_brain.hparams.wer_file = hparams["save_folder"] + "/wer_valid.txt"
    asr_brain.evaluate(
        valid_data,
        min_key="WER",
        progressbar=True,
    ...
    # Test
    asr_brain.hparams.wer_file = hparams["save_folder"] + "/wer_test.txt"
    asr_brain.evaluate(
        test_data,
        min_key="WER",
        progressbar=True,
