...
#SBATCH --job-name=const_commonvoice
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=const_commonvoice

TGT_LANG=frp
MODEL_DIR=/gpfswork/rech/czj/uef37or/ConST/checkpoints/commonvoice

fairseq-train /gpfswork/rech/czj/uef37or/ConST/commonvoice_process \
    --task speech_to_text_triplet_with_extra_mt \
    --train-subset train_commonvoice_s2p_st --valid-subset valid_commonvoice_s2p_st \
    ...
    --eval-bleu-bpe sentencepiece --eval-bleu-bpe-path /gpfswork/rech/czj/uef37or/ConST/commonvoice_process/spm_unigram10000_st.model \
    --best-checkpoint-metric bleu --maximize-best-checkpoint-metric \
    --restore-file /gpfswork/rech/czj/uef37or/ConST/checkpoints/commonvoice/checkpoint_last.pt
