...
# ------------ Load dataset ------------ #
train_data = load_dataset('csv', data_files=["/gpfswork/rech/czj/uef37or/Fine_tuning_t5/data_commonvoice/train.csv"], delimiter='\t')
valid_data = load_dataset('csv', data_files=["/gpfswork/rech/czj/uef37or/Fine_tuning_t5/data_commonvoice/valid.csv"], delimiter='\t')
