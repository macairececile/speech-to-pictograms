...
cd /gpfswork/rech/czj/uef37or/NMT_transformers/propicto_eval_commonvoice
...
TEXT=/gpfswork/rech/czj/uef37or/NMT_transformers/propicto_eval_commonvoice/final
...
fairseq-preprocess \
    ...
    --destdir propicto_eval_commonvoice/data-bin/propicto_eval.tokenized.fr-frp/ \
    --workers 20
