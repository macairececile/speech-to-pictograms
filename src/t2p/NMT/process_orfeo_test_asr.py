...
def main(folder_data_asr, model_prefix, folder_to_save, asr_model):
    all_sentences = []
    for c in corpus_name:
        src_sentences = get_text_and_generate_file(folder_data_asr, model_prefix, c, folder_to_save, asr_model)
        all_sentences.extend(src_sentences)
    create_file(all_sentences, asr_model, model_prefix, "orfeo", folder_to_save)


if __name__ == '__main__':
    # main("/gpfswork/rech/czj/uef37or/ASR_S2P_data/whisper-large-v3/", "large-v3_test_",
    #      "/gpfswork/rech/czj/uef37or/NMT_transformers/exp_orfeo/orfeo_process/",
    #      "whisper")
    main("/gpfswork/rech/czj/uef37or/ASR_S2P_data/seamlessm4t-large-v2/", "large-v2_test_",
         "/gpfswork/rech/czj/uef37or/NMT_transformers/exp_orfeo/orfeo_process/",
         "seamless")
