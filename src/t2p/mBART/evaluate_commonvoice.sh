...
#SBATCH --job-name=mt_mbart_commonvoice_eval
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=mt_mbart_commonvoice_eval
...
fairseq-generate /gpfswork/rech/czj/uef37or/Fine_tuning_mBART_MT/commonvoice_data/data/ \
