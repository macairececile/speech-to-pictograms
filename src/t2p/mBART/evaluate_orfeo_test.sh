...
#SBATCH --job-name=mt_mbart_orfeo_eval_test
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=mt_mbart_orfeo_eval_test
...
for f in "cfpb" "cfpp" "clapi" "coralrom" "crfp" "fleuron" "frenchoralnarrative" "ofrom" "reunions" "tcof" "tufs" "valibel"; do
    echo "$f"
    fairseq-generate /gpfswork/rech/czj/uef37or/Fine_tuning_mBART_MT/orfeo_data/test_splits/$f/ \
