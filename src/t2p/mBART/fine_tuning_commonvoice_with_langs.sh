...
#SBATCH --job-name=mt_mbart_fr_frp_commonvoice_langs_3
#SBATCH -A czj@v100
#SBATCH -C v100-32g
#SBATCH --gres=gpu:1
#SBATCH --ntasks=8
...
#SBATCH --output=mt_mbart_fr_frp_commonvoice_langs_3
...
# mkdir -p models/checkpoints/mt_mbart_fr_frp_commonvoice_langs
...
fairseq-train $DATA \
  ...
  --keep-last-epochs 5 \
  --restore-file models/checkpoints/mt_mbart_fr_frp_commonvoice_langs/checkpoint_last.pt
